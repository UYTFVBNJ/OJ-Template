// This code is originally provided by bungie. Many thanks.

#ifndef OJ_REDIRECT_H
#define OJ_REDIRECT_H
#ifdef DEBUG          /* 如果有宏定义 DEBUG 则编译下面的代码 */
...
static void init(int argc, char *argv[])
{
    ...
    { /* 如果命令行参数个数大于1
        ...
        if (fd != -1)
        {                           /* 判断是否打开成功，绝大多数 Linux 系统调用返回 -1 为失败 */
        ...
        if (argc > 2)
        { /* 如果命令行参数个数大于2，比如 "./main input output" */
